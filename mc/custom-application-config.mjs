...
const config = {
    ...
    env: {
        development: {
            initialProjectKey: 'wl-commercetools-uat',
        },
        production: {
    ...
    additionalEnv: {
        ...
        worldlineTestEndpoint: '${env:CTP_MC_APPLICATION_WORLDLINE_TEST_ENDPOINT}',
        worldlineLiveEndpoint: '${env:CTP_MC_APPLICATION_WORLDLINE_LIVE_ENDPOINT}',
    },
};
