...
export default defineMessages({
  ...
  paymentOption: {
    id: 'Order.paymentOption',
    defaultMessage: 'Payment Option',
  },
  worldlinePaymentResponse: {
    id: 'Order.worldlinePaymentResponse',
    defaultMessage: 'Worldline Payment Response',
  },
  status: {
    id: 'Order.status',
  ...
  filterOrders: {
    id: 'Order.filterOrders',
    defaultMessage: 'Filters Orders',
  },
  worldlineCreditCard: {
    id: 'Order.worldlineCreditCard',
    defaultMessage: 'Worldline Credit Card',
  },
  hostedApm: {
    id: 'Order.hostedApm',
    defaultMessage: 'Hosted And APMs',
  },
  redirectWorldline: {
