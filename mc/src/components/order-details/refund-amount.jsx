            ...
            <div className="transaction-form">
              <div className="input-block">
                <p className="input-label">
                  {formatMessage(messages.amountToRefund)}
                </p>
                <input
                  type="number"
                  name="refundAmount"
              ...
              <div className="transaction-button" onClick={refundPayment}>
                {loading ? (
                  ...
                  <PrimaryButton label={formatMessage(messages.refund)} />
                )}
              </div>
            </div>
            <div className="transacation-details">
              {formatMessage(messages.amountRefundedAlready)}{' '}
              <b>
                {currencyCode} {(alreadyRefundedAmount / 100).toFixed(2)}
              </b>
              <p
